...
const getWatchHistory = asyncHandler(async (req, res) => {
  const user = await User.aggregate([
    {
      $match: {
        //req.user._id fetches a string the mongoose handles the string to give id
        _id: new mongoose.Types.ObjectId(req.user?._id), // but while agg. pipelines the code is sent to server as it is i.e mongoose doesn't handle the string id
      },
    },
    {
      $lookup: {
